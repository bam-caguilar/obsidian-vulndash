...
const normalizeRuntimeSettings = (settings: VulnDashSettings): VulnDashSettings => ({
  ...
  defaultDashboardDateRangePreset: settings.defaultDashboardDateRangePreset === 'past_3_days'
    || settings.defaultDashboardDateRangePreset === 'past_7_days'
    || settings.defaultDashboardDateRangePreset === 'custom'
    || settings.defaultDashboardDateRangePreset === 'past_day'
    ? settings.defaultDashboardDateRangePreset
    : DEFAULT_SETTINGS.defaultDashboardDateRangePreset,
    ...
    this.registerView(VULNDASH_VIEW_TYPE, (leaf) =>
      new VulnDashView(
        ...
        () => this.pollingEnabled,
        {
          ...
          getDefaultDashboardDateRangePreset: () => this.settings.defaultDashboardDateRangePreset,
